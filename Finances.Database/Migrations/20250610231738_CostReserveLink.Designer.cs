...
namespace Finances.Database.Migrations
{
    ...
    [Migration("20250610231738_CostReserveLink")]
    partial class CostReserveLink
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Finances.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2025, 6, 10, 23, 17, 38, 474, DateTimeKind.Utc).AddTicks(8591),
                            Email = "daniel.deda1995@gmail.com",
                            PasswordHash = "$2a$11$HAkjDtCDfwmVmt9x.ZRfCOurJ2RpOeM4J8LdDu/FV8txXw0SmWjvu"
                        });
                });
